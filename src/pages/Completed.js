          ...
          <div className="pop-up" onClick={(e) => e.stopPropagation()}>
            ...
            <span className="close-btn" onClick={closeModal}>&times;</span>
              ...
              <div className="mb-4">
                ...
                <input id="yes-uar" style={{marginLeft:"25px"}} type="radio" name="uar"/> <label for="yes-uar">Yes</label>
                <input id="no-uar" style={{marginLeft:"15px"}} type="radio" name="uar"/> <label for="no-uar">No</label>
              </div>
              <div className="mb-4">
                <label className="form-label">
                  Reason
              ...
              <div className="pop-up-button">
                <div><input id="fee" style={{marginRight:"5px"}} type="radio"/><label for="fee">Charge closure fee</label></div>
                <button onClick={closeModal} className="close-acc">Close account</button>
              </div>
            </div>
          </div>
        </div>
